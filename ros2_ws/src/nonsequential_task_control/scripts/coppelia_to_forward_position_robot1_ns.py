...
class CoppeliaToForwardPositionRobot1(Node):
    def __init__(self) -> None:
        super().__init__("coppelia_to_forward_position_robot1_ns")
        ...
        self.get_logger().info("robot1 bridge started")
...
def main() -> None:
    rclpy.init()
    node = CoppeliaToForwardPositionRobot1()
    try:
        rclpy.spin(node)
    finally:
        node.destroy_node()
